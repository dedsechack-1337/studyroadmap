...
const PRIORITY_TOPICS = [1, 2, 4, 5, 6, 7, 9, 11, 12, 17, 19, 20, 21, 23, 29, 31, 28, 58, 59, 60];
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-none">61 Topics · 9 Phases</p>
            </div>
          </div>
              ...
              <div className="flex items-start justify-between flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-white/80 text-sm max-w-lg">
                    61 topics across 9 phases — Software Engineering, DSA, Cybersecurity, AI/ML,
            ...
            <div className="mb-4 rounded-xl bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-900 p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-600 dark:text-amber-400">
                  These 20 topics form the mathematical backbone of modern software engineering,
